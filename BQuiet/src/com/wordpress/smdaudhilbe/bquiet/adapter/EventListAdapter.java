...
public class EventListAdapter extends ArrayAdapter<EventsListItem> {
	...
	public EventListAdapter(Context context, int resource,ArrayList<EventsListItem> eventListItems) {
