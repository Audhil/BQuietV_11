 ...
 *
 */
public class GeoFenceRemover implements OnRemoveGeofencesResultListener,ConnectionCallbacks,OnConnectionFailedListener {
	
    public static String GeoIDToRemove;
	...
	private SimpleGeoFenceStore sGeoFenceStorePref;
    ...
    public GeoFenceRemover(Context context) {
        ...
        sGeoFenceStorePref = new SimpleGeoFenceStore(context);
    }
    ...
    public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
            ...
            //	remove geoId from preference
            sGeoFenceStorePref.clearGeoFence(GeoIDToRemove);
            
            //	remove data from database too
            dBConnectivity.deleteGeoFenceDetails(GeoIDToRemove);                
            
            //	disabling smsreceiver            
            int flag = PackageManager.COMPONENT_ENABLED_STATE_DISABLED;        	
        	ComponentName cName = new ComponentName(mContext,SmSReceiver.class);        	
        	mContext.getPackageManager().setComponentEnabledSetting(cName,flag,PackageManager.DONT_KILL_APP);       	
